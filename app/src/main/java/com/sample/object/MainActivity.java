...
public class MainActivity extends AppCompatActivity
    ...
    private static final String CLOUD_VISION_API_KEY = "AIzaSyDl9KK_sdv1PTkjag1r31zTvgQXWuY3t64";
    ...
    private static class LableDetectionTask extends AsyncTask<Object, Void, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            if (activity != null && !activity.isFinishing()) {
                ...
                textToSpeech = new TextToSpeech(activity.getApplicationContext(), new TextToSpeech.OnInitListener() {
                    ...
                    public void onInit(int status) {
                        if (status == TextToSpeech.SUCCESS) {
                            ...
                            if (result == TextToSpeech.LANG_MISSING_DATA ||
                                    result == TextToSpeech.LANG_NOT_SUPPORTED) {
                                Toast.makeText(activity.getApplicationContext(), "This language is not supported!",
                                        Toast.LENGTH_SHORT);
                            } else {
                                textToSpeech.setPitch(0.6f);
                                textToSpeech.setSpeechRate(1.0f);
                ...
                Button read = activity.findViewById(R.id.read);
...
//            final String msg = mImageDetails.getText().toString() ;
//
//            read.setVisibility(View.VISIBLE);
//            read.setOnClickListener(new View.OnClickListener() {
//                @Override
...
//            });
    ...
    private static String convertResponseToString(BatchAnnotateImagesResponse response) {
        StringBuilder message = new StringBuilder("Following things are found : \n\n");
